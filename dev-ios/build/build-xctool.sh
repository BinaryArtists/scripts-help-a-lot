...
provisioning_profile='apnsgkdevelopmentprofile'

#指定项目地址
workspace_path="$project_path/consumer.xcworkspace"
#指定输出归档文件地址
archive_path="$output_path/consumer_${now}.xcarchive"
#指定输出ipa地址
ipa_path="$output_path/consumer_${now}.ipa"
